            ...
            <el-table :data="rolesList" border stripe>
                ...
                <el-table-column  type="expand">
                    <template slot-scope="scope">
                        <el-row v-for="(item1,i1) in scope.row.children" :key="item1.id" :class="['bdbottm',i1===0?'bdtop':'','vcenter']">
                            <!--渲染一级权限-->
                            <el-col :span="5" >
    ...
    export default {
        ...
        methods:{
            ...
            async showSetRightDialog(role){
                ...
                //递归获取三级结点的id
                this.getLeafRight(role,this.defKeys)
                //展示树形结构对话框
                this.setRightDialogVisible=true

            },
            //通过递归的形式获取角色的三级权限的id，并保存到数据组中
            getLeafRight(node, arr){
                //如果当前的node节点不包括children 属性，则是三级节点
